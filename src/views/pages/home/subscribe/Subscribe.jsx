...
const Subscribe = () => {
    ...
    return (
        <div className="" style={{ backgroundColor: red }}>
            <div className='grid grid-cols-2  py-10  items-center container mx-auto'>
                <div className="col-span-2 md:col-span-1  flex justify-start gap-4 my-2 items-center">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex justify-end flex-wrap">
