            ...
            <div className="absolute top-0 bottom-0 left-4 flex justify-start items-center ">
                <div className="">
                    ...
                    <div className="inline-block ">
                        <NavLink to={'/'} className='flex gap-1 items-center text-white py-2 px-4 rounded-md text-sm' style={{ backgroundColor: primaryColor }}>Learn more <ArrowRightIcon className='h-4 w-4 text-xl font-serif font-bold' /></NavLink>
                    </div>
                </div>
            </div>
        </div>
