    ...
    return (
        <div className="flex md:flex-nowrap flex-wrap gap-6 px-4">
            ...
            <div className='min-h-[600px] font-sans mt-10'>
                ...
                <p className='text-justify'>– If you pay us by any mobile wallet (bKash, Rocket, Upay, Ok Wallet), then your money will be refunded in same account within 7-10 working days.</p>
