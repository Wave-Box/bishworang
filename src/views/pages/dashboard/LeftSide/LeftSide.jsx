            ...
            <div className="mt-5 md:mt-0 md:col-span-1">
                ...
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                    <div className=" py-5 bg-white space-y-3  flex flex-col">
                        ...
                        <NavLink to='/profile/change-password' className={`${location.pathname === '/profile/order' ? " active_color" : "border-white "}  border-l-4 text-md font-semibold  pl-5 py-1 tracking-wider`}>Change Password</NavLink>
