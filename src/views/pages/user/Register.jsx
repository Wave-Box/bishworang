    ...
    return (
        <>
            ...
            <form
                ...
                className="border border-gray-300 rounded-2xl p-6 md:mx-0 my-4 md:my-14 flex flex-col space-y-4"
            >
                ...
                <div className="flex justify-between items-center">
                    <label htmlFor='agree' className="label cursor-pointer gap-4">
                        ...
                        <span className="label-text">I agree to <NavLink to="/terms-condition" className={"cursor-pointer"}>terms & conditions</NavLink></span>
                    </label>
                ...
                <p className='text-center text-gray-500'>Already Have an Account? <a href="/" style={{ color: button1.color }} className={"block sm:inline-block"}>Sign in now</a></p>
            </form>
