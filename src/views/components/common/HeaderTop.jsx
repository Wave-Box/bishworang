...
const HeaderTop = () => {
    ...
    return (
        <div className=" w-full lg2:py-0 text-sm hidden md:block bg-[#AD171A] py-3">
            <div className='px-2 lg2:px-6 text-white grid grid-cols-10 justify-items-center items-center'>
                <div className="flex items-center lg2:divide-x justify-self-start col-span-2 lg2:col-span-3 xl:col-span-3">
                ...
                <div className="lg2:col-span-4 xl:col-span-4 col-span-6">
                ...
                <div className="flex items-center divide-x gap-x-4 justify-self-end lg2:col-span-3 col-span-2">
                    <CurrencyFrom />
                    {user?.verify ?
